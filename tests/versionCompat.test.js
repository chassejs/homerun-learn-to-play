...
// ---------------------------------------------------------------------------
const window = global; // versionCompat reads window.HRL_VERSION

// Provide HRL_VERSION as if version.js had loaded.
...
function withDataVersion(version, fn) {
  const orig = global.HRL_VERSION.DATA_VERSION;
  global.HRL_VERSION.DATA_VERSION = version;
  try { fn(); } finally { global.HRL_VERSION.DATA_VERSION = orig; }
}
...
// independent of the synthetic HRL_VERSION fixture used above to exercise
