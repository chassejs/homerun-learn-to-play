/* ===================================================================
   Homerun Learn to Play — versionCompat.js
   Backup/restore compatibility logic.

   Depends on window.HRL_VERSION (loaded from version.js before this).
...
window.HRL_VERSION_COMPAT = (function () {
  'use strict';
